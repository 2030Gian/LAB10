...
async def get_pokemon_from_pokeapi(pokemon_name: str) -> dict[str, Any]:
    api = f"/pokemon/{pokemon_name}"
    function = "get_pokemon_from_pokeapi"
    start_time = time.perf_counter()

    pokemon_name = pokemon_name.strip().lower()
    url = f"{settings.POKE_API_BASE_URL.rstrip('/')}/pokemon/{pokemon_name}/"
    ...
    try:
        ...
        raise RuntimeError("Error calling external PokeAPI")
